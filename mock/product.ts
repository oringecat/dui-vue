        ...
        rawResponse: (req, res) => {
            ...
            const categories = [
                ...
                { id: 1100, parentId: 1000, code: 'phone', categoryName: '手机通讯', status: 1, icon: '', sort: 1, attrs: [], sales: [] },
                {
                    ...
                    attrs: [
                        { id: 100, attributeId: 100, valueType: 1, required: true },
                        ...
                        { id: 104, attributeId: 104, valueType: 2, required: false },
                    ],
                    sales: [
        ...
        rawResponse: (req, res) => {
            mockResponse(res, {
                ...
                data: {
                    ...
                    attrs: [
                        { id: 1000, attributeId: 100, attributeValue: '极光蓝' },
                        { id: 1001, attributeId: 101, attributeValue: '256GB' },
                        { id: 1002, attributeId: 102, attributeValue: '全网通5G' },
                        { id: 1003, attributeId: 103, attributeValue: '6.7英寸' },
                        { id: 1004, attributeId: 104, attributeValue: 'iOS' },
                    ],
                    images: [
                        ...
                        skus: [
                            {
                                ...
                                code: 'SP0001-001',
                                specs: [
                                    { id: 501, attributeId: 100, valueId: 1001, specName: '亮黑色' },
                                    { id: 502, attributeId: 101, valueId: 1012, specName: '256GB' },
                                    { id: 503, attributeId: 102, valueId: 1021, specName: '全网通5G' },
                                ],
                                price: 6999,
                                stock: 50,
                            ...
                            },
                            {
                                ...
                                code: 'SP0001-002',
                                specs: [
                                    { id: 504, attributeId: 100, valueId: 1003, specName: '极光蓝' },
                                    { id: 505, attributeId: 101, valueId: 1013, specName: '512GB' },
                                    { id: 506, attributeId: 102, valueId: 1021, specName: '全网通5G' },
                                ],
                                price: 7998,
                                stock: 0,
