<template>
    <app-dialog class="attribute-edit-group" :show="show">
        <app-table :data="attributeStore.groups" :columns="tableColumns" v-loading="attributeStore.loading">
            <template #name="{ row }">
...
const tableColumns: TableColumn<Attribute.AttributeGroup>[] = [
    { field: 'id', label: 'ID' },
    { field: 'name', label: '名称' },
    { field: 'code', label: '代码' },
